...
from sortlib.mystery import mystery_sort

def test_mystery_empty_array():
    """Test the sorting algorithm on an empty array.
    """
    items = []
    int_greater = lambda x, y: x > y
    mystery_sort(items, int_greater)
...
def test_mystery_small_int_array():
...
def test_mystery_int_array_some_equal():
    """Test the sorting algorithm with a small array of ints, sorting
    from least to greatest.
    """
    items = [7, 2, 2, 2, 2, 1]
    ...
    sorted_expected = [1, 2, 2, 2, 2, 7]

    assert items == sorted_expected


def test_mystery_small_int_array_reversed():
    """Test the sorting algorithm with a small array of ints, sorting
    from greatest to least.
    """
    items = [12, 54, 32, 41, 2, 5, 1, 0]
    int_less = lambda x, y: y > x
    mystery_sort(items, int_less)
...
def test_mystery_small_str_array():
    ...
    mystery_sort(items, first_char_alphabetical)
