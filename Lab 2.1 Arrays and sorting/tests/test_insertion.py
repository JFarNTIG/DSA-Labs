...
def test_insertion_small_int_array():
...
def test_insertion_small_int_array_reversed():
    """Test the sorting algorithm with a small array of ints, sorting
    from greatest to least.
    """
    items = [12, 54, 32, 41, 2, 5, 1, 0]
    int_less = lambda x, y: y > x
    insertion_sort(items, int_less)
...
def test_insertion_small_str_array():
    ...
    insertion_sort(items, first_char_alphabetical)
